...
import { Bug, AlertTriangle, CheckCircle, ExternalLink, X, ShieldAlert, User, RefreshCw, PlusCircle, Camera, Video, Trash2, StopCircle, Eye } from 'lucide-react';
            ...
            <div className="space-y-3 pt-2 border-t border-slate-200">
              ...
              <div className="grid grid-cols-2 gap-3">
                  ...
                  {screenshotUrl ? (
                    <div className="relative group">
                      ...
                      <div className="absolute inset-0 bg-slate-950/70 opacity-0 group-hover:opacity-100 transition-all rounded-xl flex items-center justify-center space-x-2">
                        <button
                          type="button"
                          onClick={() => setPreviewMedia({ url: screenshotUrl, type: 'image', title: `Re-open Screenshot Evidence [${selectedBugToReopen}]` })}
                ...
                <div className="border border-slate-200 bg-slate-50 rounded-2xl p-3 space-y-2 text-center">
                  ...
                  {videoUrl ? (
                    <div className="relative group">
                      <video src={videoUrl} className="w-full h-24 object-cover rounded-xl border border-slate-300 shadow-sm" />
                      <div className="absolute inset-0 bg-slate-950/70 opacity-0 group-hover:opacity-100 transition-all rounded-xl flex items-center justify-center space-x-2">
                        <button
                          type="button"
                          onClick={() => setPreviewMedia({ url: videoUrl, type: 'video', title: `Re-open Video Recording Evidence [${selectedBugToReopen}]` })}
                          className="px-2.5 py-1 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg font-bold text-[10px] flex items-center shadow-xs"
                        >
                  ...
                  {screenshotUrl ? (
                    <div className="relative group">
                      ...
                      <div className="absolute inset-0 bg-slate-950/70 opacity-0 group-hover:opacity-100 transition-all rounded-xl flex items-center justify-center space-x-2">
                        <button
                          type="button"
                          onClick={() => setPreviewMedia({ url: screenshotUrl, type: 'image', title: `Defect Screenshot Proof [${testCase.key}]` })}
                          className="px-2.5 py-1 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg font-bold text-[10px] flex items-center shadow-xs"
                        >
                          <Eye className="w-3 h-3 mr-1" /> View Image
                        </button>
                  ...
                  {videoUrl ? (
                    <div className="relative group">
                      ...
                      <div className="absolute inset-0 bg-slate-950/70 opacity-0 group-hover:opacity-100 transition-all rounded-xl flex items-center justify-center space-x-2">
                        <button
                          type="button"
                          onClick={() => setPreviewMedia({ url: videoUrl, type: 'video', title: `Defect Video Recording Proof [${testCase.key}]` })}
                          className="px-2.5 py-1 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg font-bold text-[10px] flex items-center shadow-xs"
                        >
                          <Eye className="w-3 h-3 mr-1" /> View / Play Video
                        </button>
